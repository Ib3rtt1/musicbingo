...
LANGUAGE_CODE = 'es-cl'  # Configura el sistema en Español de Chile

TIME_ZONE = 'America/Santiago'  # Ajusta la hora a tu zona local
...
# Añade esta línea para indicarle a Django la ruta de la carpeta static
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# Redirige al Login si un usuario intenta entrar a una vista protegida sin autenticarse
LOGIN_URL = 'login'

# ¡ESTA ES LA LÍNEA CRUCIAL QUE FALTA! Redirige al cartón tras un login exitoso
